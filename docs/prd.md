...
| P1-13 | QwenPaw 全渠道迁移 | 一次性覆盖 iMessage、Discord、钉钉、飞书、QQ、Telegram、Mattermost、MQTT、Matrix、Slack、Voice、SIP、企业微信、小艺、腾讯元宝、微信 iLink、OneBot v11。协议适配使用 TypeScript 并接入唯一 DigitalMate Agent；iMessage、SIP 等专用环境通过无模型、无记忆的渠道运行节点连接。所有渠道必须具备配置、健康、访问控制、去重、重连、收发、测试和文档；缺少平台账号、接入资格或运行环境时准确标记为待外部验收 |
